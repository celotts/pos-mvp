...
from schemas.user import User, UserBootstrapIn, UserCreate
...
async def bootstrap_admin(
    *,
    ...
    if user_in.bootstrap_secret.get_secret_value() != settings.BOOTSTRAP_SECRET_KEY:
        raise HTTPException(
    ...
    try:
        user = await crud_user.create_user(db=db, user_in=user_to_create)
